...
const BarChart: React.FC<BarChartProps> = ({ summaryScope = "all" }) => {
  ...
  const tickFill = darkMode ? "#94a3b8" : "#6B7280";
  const refLineStroke = darkMode ? "#64748b" : "#9CA3AF";
          ...
          >
            ...
            <Tooltip
              ...
              content={({ active, payload, label }) => {
                ...
                return (
                  <div className="rounded-lg border border-gray-200 bg-white px-3 py-2 text-xs shadow-md dark:border-slate-600 dark:bg-slate-800 dark:shadow-black/40">
                    <div className="mb-1 font-medium text-gray-700 dark:text-gray-100">
                      {String(label)}
                    </div>
                    ...
                    <div
                      className={
                        row.difference >= 0
                          ? "mt-1 border-t border-gray-100 pt-1 font-semibold text-green-800 dark:border-slate-600 dark:text-green-300"
                          : "mt-1 border-t border-gray-100 pt-1 font-semibold text-red-800 dark:border-slate-600 dark:text-red-300"
                      }
                    >
