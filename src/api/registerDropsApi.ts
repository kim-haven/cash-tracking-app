...
export async function fetchRegisterDropsPage(
  ...
  const url = new URL(`${base}/api/register-drops`);
...
export async function createRegisterDrop(
  ...
  const res = await fetch(`${base}/api/register-drops`, {
    method: "POST",
    headers: {
...
export async function addRegisterDropTimeOut(
  ...
  const res = await fetch(`${base}/api/register-drops/add-time-out`, {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
      Accept: "application/json",
...
export async function bulkRegisterDropTimeOut(
  ...
  const res = await fetch(`${base}/api/register-drops/bulk-time-out-update`, {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
      Accept: "application/json",
